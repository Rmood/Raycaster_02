 ...
 * the display corresponds to a point on the view plane and a ray
 * passing from the eye through that point into the scene.
 * <p/>
...
public class Camera {
    ...
    /**
     * Constructs a camera at a certain position, pointing in a certain
    ...
    /**
     * Constructs a camera which is not tilted (its top points
     * upwards).
     */
